...
//  c) This program runs in O(n) time with n being the length of the string. This is because there are no nested loops in the program and the one loop is always running the length of the string.
...
//         print: The Striog is not balanced
//         return
